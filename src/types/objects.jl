...
- `bottom_anchor::Anchor`: Bottom anchor specification. (**Default** = `_NO_ANCHOR`)
- `left_anchor::Anchor`: Left anchor specification. (**Default** = `_NO_ANCHOR`)
- `right_anchor::Anchor`: Right anchor specification. (**Default** = `_NO_ANCHOR`)
- `top_anchor::Anchor`: Top anchor specification. (**Default** = `_NO_ANCHOR`)
- `center_anchor::Anchor`: Center anchor specification. (**Default** = `_NO_ANCHOR`)
- `middle_anchor::Anchor`: Middle anchor specification. (**Default** = `_NO_ANCHOR`)
